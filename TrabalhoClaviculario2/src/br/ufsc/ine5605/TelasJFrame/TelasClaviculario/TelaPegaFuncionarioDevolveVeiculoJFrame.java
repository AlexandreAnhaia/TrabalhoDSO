 ...
 * @author Pichau
 */
public class TelaPegaFuncionarioDevolveVeiculoJFrame extends JFrame {
    ...
    public TelaPegaFuncionarioDevolveVeiculoJFrame(Claviculario owner) {
        this.owner = owner;
        ...
        public void actionPerformed(ActionEvent e) {
            if (e.getActionCommand().equals(ok)) {
                try {
                    ...
                    if (funcionario != null) {
                        owner.getTelaDevolverChaveJFrame(funcionario);
                        setVisible(false);
